...
<div class="w-full h-[70px] sticky top-0 bg-white border-b border-[#d5e0d5] shadow-sm z-50">
    <div class="h-full container flex mx-auto justify-between items-center">
        ...
        <div class="flex gap-14 items-center justify-end w-[60%]">
            <div class="flex items-center w-[50%] justify-between border-[#d5e0d5] border-[1px] rounded-full px-4 py-2">
                <div class="w-[25px]">
            ...
            <div class="flex gap-4 items-center">
                <div class="rounded-full cursor-pointer border border-[#d5e0d5] p-2">
