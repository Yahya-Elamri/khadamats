    ...
    <div class="container flex mx-auto gap-3 items-start justify-center h-full my-10 p-20 rounded-xl border border-[#d5e0d5]">
        ...
        <form action="/addnewpost" method="POST" class="w-[70%] flex justify-start flex-col gap-5 items-start border-l border-[#d5e0d5] px-20">
            ...
            <div class="w-[80%] flex flex-col gap-2">
                ...
                <input class="border border-[#d5e0d5] px-6 py-2 rounded-xl" id="title" name="title" type="text" placeholder="Titre">
            </div>
            <div class="w-[80%] flex flex-col gap-2">
                <label class="poppins-regular text-lg" for="description">Description</label>
                <textarea class="border border-[#d5e0d5] px-6 py-2 rounded-xl" rows="8" cols="50" id="description" name="description" placeholder="Description"></textarea>
            </div>
            <div class="w-[80%] flex flex-col gap-2">
                <label class="poppins-regular text-lg" for="proffession">Métier Recherché</label>
                <input class="border border-[#d5e0d5] px-6 py-2 rounded-xl" id="proffession" name="proffession" type="text" placeholder="Métier Recherché">
            </div>
            <div class="w-[80%] flex flex-col gap-2">
            ...
            <div class="w-[80%] flex flex-col gap-2">
                ...
                <input class="border border-[#d5e0d5] px-6 py-2 rounded-xl" id="adresse" name="adresse" type="text" placeholder="Localisation">
            </div>
